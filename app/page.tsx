              ...
              items={[
                ...
                },
                {
                  ...
                  bullets: [
                    ...
                    "Drove front-end architecture decisions for client websites and applications across performance, accessibility (WCAG 2.1 AA) standards to meet NC ADA compliance requirements.",
                  ],
