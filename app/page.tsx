              ...
              items={[
                {
                  ...
                  bullets: [
                    ...
                    "Introduced modern build pipelines using Vite and Github actions.",
                    "Build, style, and ship high-quality websites, web-apps and ui component systems.",
                    "Spearhead company-wide WCAG accessibility initiatives such as creating documentation for best practices, establishing a standard accessibility checklist for developers, and facilitating knowledge shares to clients. ",
                  ],
                  href: "https://springerstudios.com",
                  external: true,
                },
