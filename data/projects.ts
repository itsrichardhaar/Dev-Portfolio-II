...
export const projects: Project[] = [
  {
    ...
    year: 2026,
    summary:
      "Created a desktop app that gives Claude Code users visibility over their scattered AI coding sessions: auto-discovers every project, renders session transcripts, resumes sessions in live embedded terminals, and generates LLM-powered activity analyses.",
  ...
  },
  {
    ...
    year: 2025,
    summary: "Built with React + TypeScript, this application leverages three.js to render a 3D storage facility model. The application allows users to customzie their own digital building and dynamically select textures that are mapped to different mesh layers.",
    madeAt: "Springer Studios",
